...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/8uvwVspigM)
...
```sh
npx nx serve Tic-Tac-Toe
```

To create a production bundle:

```sh
npx nx build Tic-Tac-Toe
```

To see all available targets to run for a project, run:

```sh
npx nx show project Tic-Tac-Toe
```
